...
int main(int argc, char *argv[])
{
	...
	//Tentukan apakah status sumber file adalah folder
	struct stat st;
	fstat(fd_src, &st);
	if (st.type == T_DIR)
	{
	...
	//Tentukan apakah parameter kedua berakhir dengan "/", jika ya , brarti menggunakan fullpath
	char com[128] = {};
	strcpy(com, argv[2]);
